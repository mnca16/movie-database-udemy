...
const deleteMovieHandler = (movieId) => {
    ...
    toggleBackdrop();
    const cancelDeletionBtn = deleteMovieModal.querySelector('.btn--passive'); //cancel btn
    const confirmDeletionBtn = deleteMovieModal.querySelector('.btn--danger'); //yes btn
